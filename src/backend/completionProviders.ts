...
let webviewCompletionItems: WebviewCompletionItem[] = [];

function toWebviewCompletionItems(
  wordsList: string[],
  kind: string,
): WebviewCompletionItem[] {
  return wordsList.map((label) => ({ label, kind }));
}

export function getWebviewCompletionItems(): WebviewCompletionItem[] {
  return webviewCompletionItems;
}
...
export function activate(context: vscode.ExtensionContext) {
  ...
  webviewCompletionItems = [
    ...toWebviewCompletionItems(typeWords, "Class"),
    ...toWebviewCompletionItems(functionWords, "Function"),
    ...toWebviewCompletionItems(constWords, "Constant"),
    ...toWebviewCompletionItems(keyWords, "Keyword"),
  ];

  function createCompletionProvider(
    wordsList: string[],
    itemType: vscode.CompletionItemKind,
  ) {
  ...
  context.subscriptions.push(
    createCompletionProvider(typeWords, vscode.CompletionItemKind.Class),
  );
  context.subscriptions.push(
    createCompletionProvider(functionWords, vscode.CompletionItemKind.Method),
  );
  context.subscriptions.push(
    createCompletionProvider(constWords, vscode.CompletionItemKind.Property),
  );
  context.subscriptions.push(
    createCompletionProvider(keyWords, vscode.CompletionItemKind.Keyword),
  );
}
